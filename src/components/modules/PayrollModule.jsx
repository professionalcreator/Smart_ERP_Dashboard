...
import { DollarSign, Landmark, Percent, Heart, ShieldAlert } from 'lucide-react';
        ...
        <div style={styles.resultColumn}>
          <div style={styles.resultCard} className="glass-panel">
            ...
            <div style={styles.breakdownBar}>
              ...
              />
              <motion.div 
                style={{ ...styles.barSegment, backgroundColor: 'var(--accent-border)', width: `${benefitsPercent}%` }}
...
const styles = {
  ...
  complianceCard: {
    ...
    alignItems: 'center',
    gap: '12px',
    border: '1px solid rgba(255, 94, 132, 0.1)',
  },
  complianceText: {
    fontSize: '12px',
    color: 'var(--text-secondary)',
