...
import { TrendingUp, DollarSign, Users, Award, RefreshCw } from 'lucide-react';
      ...
      <div className="responsive-grid-reports">
              ...
              {activeTab === 'financials' ? (
                ...
                <>
                  ...
                  {MONTHLY_DATA.map((d, i) => {
                    ...
                    // Injecting actual backend headcount for the last bar (current month)
                    const headcount = (i === MONTHLY_DATA.length - 1) ? stats.totalEmployees : d.headcount;
                    const barHeight = ((headcount) / 25) * (height - 2 * padding);
              ...
              >
                ...
                {activeTab === 'financials' ? (
                  ...
                  <div style={styles.tooltipRow}>
                    ...
                    <strong>{hoveredIndex === MONTHLY_DATA.length - 1 ? stats.totalEmployees : MONTHLY_DATA[hoveredIndex].headcount} active</strong>
                  </div>
                )}
              </div>
            )}
        ...
        <div style={styles.metricsColumn}>
          ...
          <div style={styles.metricCard} className="glass-panel">
            ...
            <div>
              <span style={styles.metricLabel}>Total Staff (Live)</span>
              <h4 style={styles.metricValue}>{stats.totalEmployees} employees</h4>
              <span style={styles.metricTrend}>Attendance Rate: {stats.presentRate}%</span>
            </div>
          </div>
          ...
          <div style={styles.metricCard} className="glass-panel">
            ...
            <div>
              <span style={styles.metricLabel}>Inventory Stock Warnings</span>
              <h4 style={{ ...styles.metricValue, color: stats.lowStockCount > 0 ? 'var(--danger)' : 'var(--success)' }}>
                {stats.lowStockCount} items low
              </h4>
              <span style={styles.metricTrend}>Total tracked items: {stats.totalStockItems}</span>
            </div>
          </div>
        </div>
