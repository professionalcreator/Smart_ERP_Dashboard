...
import { Package, Plus, Minus, AlertTriangle, CheckCircle, ArrowUpDown, RefreshCw } from 'lucide-react';
...
export default function InventoryModule() {
  ...
  const adjustStock = async (id, amount) => {
    ...
    try {
      ...
      console.warn('Backend update failed, stock adjusted locally.', err);
    }
  };
      ...
      <div style={styles.toolbar}>
        ...
        <div style={styles.filterControls}>
          ...
          <button 
            ...
            style={{
              ...styles.toggleBtn,
              backgroundColor: filterLowStock ? 'var(--danger-soft)' : 'var(--bg-secondary)',
            ...
            {sortedAndFilteredItems.map(item => {
              ...
              return (
                <motion.div
                  ...
                  style={{
                    ...styles.card,
                    borderColor: isLowStock ? 'rgba(220, 38, 38, 0.35)' : 'var(--accent-border)',
                    boxShadow: isLowStock ? '0 10px 30px rgba(220, 38, 38, 0.04)' : 'var(--shadow-md)',
                  }}
...
const styles = {
  ...
  cardActions: {
    ...
    padding: '8px 12px',
    borderRadius: '16px',
    border: '1px solid rgba(109, 76, 65, 0.02)',
  },
  adjustBtn: {
    width: '28px',
    height: '28px',
